...
1. **Follow the Design System**: Read [DESIGN_SYSTEM.md](./DESIGN_SYSTEM.md) before designing any new slash command, embed, or button panel.
...
- [ ] Feature adheres to [DESIGN_SYSTEM.md](./DESIGN_SYSTEM.md).
